...
export default function RoleManager({ onClose }: RoleManagerProps) {
  const [selectedRole, setSelectedRole] = useState<string>(Roles.OPERATOR_REGISTER);
          ...
          <div>
            ...
            <div className="space-y-2">
              {Object.values(Permissions).map((permission) => {
                const hasPermission =
                  rolePermissions[selectedRole as keyof typeof rolePermissions]?.includes(
                    permission
                  );
                return (
                  <div
