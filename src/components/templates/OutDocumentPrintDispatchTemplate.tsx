...
interface OutDocumentPrintDispatchTemplateProps {
  onPrint?: () => void;
}

export default function OutDocumentPrintDispatchTemplate({
  onPrint,
}: OutDocumentPrintDispatchTemplateProps) {
  ...
  // Calculate netto
  const bruto = weighIn?.weight || 0;
  const tarra = weighOut?.weight || 0;
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={3} className="border border-black p-2 text-center font-bold bg-gray-100">
              DESPATCH PRODUCT/WEIGHBRIDGE TICKET
            </td>
          </tr>
                ...
                <div>
                  <div className="text-left mb-4 space-y-2 text-sm">
                    ...
                    <div className="grid grid-cols-[110px_auto] gap-2">
                      ...
                      <span>: {document?.relation_name || '-'}</span>
                    </div>
                    <div className="grid grid-cols-[110px_auto] gap-2">
                      <span className="font-semibold">VESSEL NAME</span>
                      <span>: {document?.vessel_name || '-'}</span>
                    </div>
                    <div className="grid grid-cols-[110px_auto] gap-2">
