  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="doNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="DO Number" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="poNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="PO Number" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="contractNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="SO Number" />}
      />
    </div>
  );
}
...
export function DestinationMolecule({ control, Controller }) {
  return (
    <Controller
      name="destination"
      control={control}
      render={({ field }) => <StyledInput {...field} placeholder="Destination" />}
    />
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="millOriginal"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="Mill Original" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="relationName"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="Relation Name" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="siNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="SI Number" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="bcType"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="Type BC" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="bcNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="BC Number" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="spbNumber"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="SPB Number" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="spbDate"
        control={control}
        render={({ field }) => <StyledDate {...field} placeholder="SPB Date" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="ffa"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="FFA" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="moist"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="Moist" />}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Controller
        name="impurity"
        control={control}
        render={({ field }) => <StyledInput {...field} placeholder="Impurity" />}
      />
    </div>
  );
}
