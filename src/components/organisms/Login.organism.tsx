...
import {
  ButtonLoginAction,
  LoginTxtBoxPasswordMolecule,
  LoginTxtBoxUsernameMolecule,
} from '@/components/molecules/Login.molecules';
import { Controller } from 'react-hook-form';

export default function LoginOrganism(control, { onSuccess }: { onSuccess?: () => void }) {
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <LoginTxtBoxUsernameMolecule control={control} Controller={Controller} />
          <LoginTxtBoxPasswordMolecule control={control} Controller={Controller} />
          <ButtonLoginAction onClose={onSuccess} />
        </form>
      </div>
    </div>
  );
